...
?>
  			<tr>
<!--  				<td rowspan="<?php echo $num ; ?>"><input name="chkDel[]" type="checkbox" value="<?php echo $objResult["poID"] ?>"></td>-->
...
-->          	
  ...
  <tr>
    <td><div align="center">
    <input name="Submit" type="submit" value="คลิกที่นี่ เพื่อลบรายการวางบิล">
	<a href="poExport.php?dateInput3=<?php echo $nbeginDate ; ?>&dateInput4=<?php echo $nendDate; ?>" target = "_blank">
	<input type="button" name="Button" value="พิมพ์รายงานการวางบิล" onClick="#'"></a>
	</div></td>
	</td>
  </tr>
  <tr>

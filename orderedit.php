...
<form action="orderedit1.php" method="post" name="form1" id="form1" target="ifrm"> 
<table width="100%" border="0">
  <tr>
    <td><table width="100%" border="0">
  		<tr>
        		<td colspan="5"><div align="center">แบบรายงานใบสั่งซื้อ</div></td>
        </tr>
      	<tr>
        	 <td colspan="5"><div align="center">เลือกช่วงวันที่ใบสั่งซื้อ</td>
       	</tr>
       	<tr>
...
mysql_close($Conn); 
?>
<div align="center"><iframe id="iframe_target" name="ifrm" src="#" height="900" width="100%" scrolling="auto" frameborder="no"></iframe></div>
</body>

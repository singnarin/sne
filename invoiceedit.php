...
<script language="javascript"> 
  ...
  function ExportData() { 
   window.location =  "invoiceExport.php?dateInput3=" + document.getElementById("dateInput3").value + "&dateInput4=" + document.getElementById("dateInput4").value + "&txtSiteTypeID=" + document.getElementById("txtSiteTypeID").value + "&txtEmpID=" + document.getElementById("txtEmpID").value ;  
  }
function OpenPopup2()
	{
...
<table width="100%" border="0">
  <tr>
    <td><table width="100%" border="0">
      	...
      	<tr>
        	 <td colspan="5"><div align="center">เลือกช่วงวันที่ใบกำกับภาษี</td>
       	</tr>
       	<tr>
        	 ...
        	 <?php  include ("include/calendaScript.php"); ?>
			</div></td>
       	</tr>
       	<tr>
        	 <td colspan="5"><div align="center">

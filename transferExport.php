...
$txtSiteTypeID = $_GET["txtSiteTypeID"];
$txtEmpID = $_GET["txtEmpID"];
...
<form name="form1" method="GET" action="deltransfer.php">
  <tr>
...
?>
  			<tr>
    			<td><div align="center"><?php echo $objResult["TransferID"];?></div></td>
    	<?php 

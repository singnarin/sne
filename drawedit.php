...
<script language="javascript"> 
  ...
  function ExportData() { 
   window.location =  "drawExport.php?dateInput3=" + document.getElementById("dateInput3").value + "&dateInput4=" + document.getElementById("dateInput4").value + "&txtSiteTypeID=" + document.getElementById("txtSiteTypeID").value + "&txtEmpID=" + document.getElementById("txtEmpID").value ;  
  }
  function OpenPopup1()
	{
...
<table width="100%" border="0">
  <tr>
    <td><table width="100%" border="0">
  		<tr>
        		<td colspan="5"><div align="center">แบบรายงานการขอเบิกเงิน</div></td>
        </tr>
      	<tr>

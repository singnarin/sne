...
<table width="100%" border="0" bordercolor="#0000FF" style="border-collapse:collapse;">
  ...
  <tr>
    <td><div align="center">เพิ่มใบสั่งซื้อ</div></td>
  </tr>
  <tr>
    <td><div align="center">
      <table width="600" border="0">
	  	<form id="form1" name="form1" method="post" action="orderadd1.php">
        <tr>
          <td width="200">เลขที่ใบสั่งซื้อ</td>
          <td width="400"><input type="text" name="txtOderID"  /></td>
        </tr>
        <tr>
          <td>วันที่</td>
        ...
        <tr>
          <td>บริษัท</td>
          <td><input type="text" name="txtPartnersID" id="txtPartnersID" readonly="readonly" />
